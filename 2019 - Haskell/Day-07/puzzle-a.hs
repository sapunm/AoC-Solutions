...
computeThrust :: [Int] -> Int -> [Int] -> Int
computeThrust ampControllerProgram ampInput phaseSettings
    | null phaseSettings = ampInput
    | otherwise = computeThrust ampControllerProgram (head (computeProgram ampControllerProgram 0 [head phaseSettings, ampInput] [])) (drop 1 phaseSettings)

maxThrust :: [Int] -> Int
maxThrust ampControllerProgram = maximum $ map (computeThrust ampControllerProgram 0) $ permutations [0..4]
